...
class ExamScheduleTeacherModel {
  final String? date;
  ...
  ExamScheduleTeacherModel copyWith({
    String? date,
    String? dayOfWeek,
    String? startPeriod,
    String? endPeriod,
    ...
    return ExamScheduleTeacherModel(
      date: date ?? this.date,
  ...
  factory ExamScheduleTeacherModel.fromMap(Map<String, dynamic> map) {
    return ExamScheduleTeacherModel(
  ...
  factory ExamScheduleTeacherModel.fromJson(String source) =>
      ExamScheduleTeacherModel.fromMap(
          json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'ExamScheduleTeacherModel(date: $date, dayOfWeek: $dayOfWeek, startPeriod: $startPeriod, endPeriod: $endPeriod, examTime: $examTime, courseCode: $courseCode, courseName: $courseName, roomName: $roomName)';
  }

  @override
  bool operator ==(covariant ExamScheduleTeacherModel other) {
