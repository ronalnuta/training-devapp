...
class TimetableTeacherModel {
  ...
  TimetableTeacherModel copyWith({
    String? date,
    String? dayOfWeek,
    String? startPeriod,
    String? endPeriod,
  ...
  factory TimetableTeacherModel.fromMap(Map<String, dynamic> map) {
    return TimetableTeacherModel(
  ...
  factory TimetableTeacherModel.fromJson(String source) =>
      TimetableTeacherModel.fromMap(
          json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'TimetableTeacherModel(date: $date, dayOfWeek: $dayOfWeek, startPeriod: $startPeriod, endPeriod: $endPeriod, courseCode: $courseCode, courseName: $courseName, roomName: $roomName)';
  }

  @override
  bool operator ==(covariant TimetableTeacherModel other) {
